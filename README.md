...
A [Postman](https://www.postman.com) collection that contains 250+ requests and example responses for the following Salesforce Platform APIs::
<table><tbody><tr><td>Auth<br>Bulk (v1 &amp; v2)<br>Composite<br>Connect<br>CPQ<br>Einstein Prediction Service<br>Event Platform</td><td>GraphQL<br>Metadata<br>REST<br>Subscription Management<br>Tooling<br>UI</td></tr></tbody></table>
